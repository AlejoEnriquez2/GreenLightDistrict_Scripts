...
class RunnerConfig:
    ...
    def start_measurement(self, context: RunnerContext) -> None:
        ...
        profiler_cmd = f'sudo powerjoular -l -a {self.target} -f {context.run_dir / f"powerjoular-{self.target}.csv"}'
    ...
    def populate_run_data(self, context: RunnerContext) -> Optional[Dict[str, Any]]:
        ...
        # powerjoular-PID.csv - Power consumption of that specific process
        df = pd.read_csv(context.run_dir / f"powerjoular-{self.target}.csv")
        run_data = {
